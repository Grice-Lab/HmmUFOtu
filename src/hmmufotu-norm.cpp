...
void printUsage(const string& progName) {
	cerr << "Usage:    " << progName << "  <OTU-IN> <OTU-OUT> [options]" << endl
		 ...
		 << "Options:    --method  STR      : normalizing method, only support 'constant' at now [" << DEFAULT_METHOD << "]" << endl
...
int main(int argc, char* argv[]) {
	...
	writeProgInfo(out, string(" normalized OTU table generated by ") + argv[0]);
	otuTable.save(out, TABLE_FORMAT);
}
