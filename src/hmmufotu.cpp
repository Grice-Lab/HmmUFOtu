...
int main(int argc, char* argv[]) {
	...
	out << "id\tdescription\t" << HmmAlignment::TSV_HEADER << "\t" + PTUnrooted::PTPlacement::TSV_HEADER << endl;
	if(chiOut.is_complete())
		chiOut << "id\tdescription\t" << HmmAlignment::TSV_HEADER << "\t" + PTUnrooted::PTPlacement::TSV_HEADER << endl;
